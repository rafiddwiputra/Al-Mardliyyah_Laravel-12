...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pendaftaran_santri', function (Blueprint $table) {
            ...
            $table->foreignId('data_ortu_id')->unique()->constrained('data_ortu')->cascadeOnDelete();
            $table->foreignId('program_id')->constrained('program_pendidikan')->restrictOnDelete();
            ...
            $table->enum('jenis_kelamin', ['putri', 'putra']);
