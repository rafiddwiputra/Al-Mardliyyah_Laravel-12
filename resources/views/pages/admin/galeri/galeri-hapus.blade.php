<div id="deleteModal"
    ...
    <div class="bg-white w-full max-w-sm rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 scale-95" id="deleteModalContent">
        ...
        <form id="formHapusGaleri" method="POST">
            ...
            <div class="p-5 text-center">
                ...
                <p class="text-xs text-gray-500 mb-4 bg-gray-50 py-2 rounded">
                    Galeri: 
                    <span id="hapus_judul_text" class="font-semibold text-gray-800 italic">
