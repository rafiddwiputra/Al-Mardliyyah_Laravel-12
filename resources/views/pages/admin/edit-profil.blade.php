...
<div class="p-6">
    ...
    <div class="border border-[#D9D9D9] rounded p-6">
        ...
        <div class="flex flex-col items-center text-center mb-8">
            ...
            <!-- AVATAR -->
            <div class="w-20 h-20 rounded-full bg-[#1E5631] flex items-center justify-center mb-3">
            ...
            <p class="text-xs text-gray-500 mb-3">
                admin@almardliyiyah.id
            </p>

            <!-- BUTTON -->
            <button class="flex items-center gap-2 bg-[#1E5631] text-white text-xs px-3 py-1.5 rounded">
        ...
        <div class="flex justify-end gap-2 mt-6">
            ...
            <button class="px-4 py-2 text-sm bg-[#1E5631] text-white rounded">
                Simpan Perubahan
            </button>
