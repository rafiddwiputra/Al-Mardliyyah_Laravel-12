    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Kelola informasi mengenai syarat dan ketentuan calon santri baru
            </p>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-2 rounded-lg text-sm flex items-center gap-2">
            ...
            <span>Tuliskan poin persyaratan secara manual dengan memisahkan baris menggunakan tombol Enter.</span>
        </div>
    </div>
    ...
    <div class="bg-white w-full max-w-lg rounded-xl overflow-hidden shadow-lg transform scale-95 transition-transform duration-300">
        <form id="editForm" method="POST">
            ...
            <div class="bg-[#1E5631] text-white text-center py-3 font-semibold flex justify-between items-center px-4">
                <span>Edit Persyaratan Pendaftaran</span>
            ...
            <div class="p-5 space-y-4">
                ...
                <div>
                    <label class="text-sm font-bold text-gray-700">Daftar Persyaratan Pendaftaran</label>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Gunakan 'enter' untuk membuat baris persyaratan baru. Titik (bullet) akan otomatis dibuat di Landing Page.</p>
                </div>
...
<script>
    ...
    function openModal(id){
        ...
        // Pancing reflow agar transisi jalan
    ...
    function openEditModal(button){
        ...
        // Pastikan URL Action sesuai dengan rute web.php kamu
        document.getElementById('editForm').action = '/admin/persyaratan-pendaftaran/' + id;
