...
<div class="flex justify-between items-center mt-6">
        ...
        <a href="/admin/data-pendaftar"
           class="border border-[#1E5631] text-[#1E5631] px-5 py-2 rounded-lg text-sm hover:bg-[#1E5631] hover:text-white transition flex items-center gap-2">
            ← Kembali
        </a>

        @if(strtolower($data->status) === 'diterima')
            <a href="{{ route('admin.pendaftar.cetak-bukti', $data->id) }}" target="_blank"
               class="bg-[#1E5631] text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-green-800 transition flex items-center gap-2 shadow-sm">
