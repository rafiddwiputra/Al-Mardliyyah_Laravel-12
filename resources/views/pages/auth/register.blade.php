    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-12 max-w-5xl mx-auto">
        ...
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                ...
                {{-- 2. EMAIL (Dipindah ke sini agar berurutan di HP dan bersebelahan dengan Nama di PC) --}}
                <div class="space-y-2">
                    <label class="block text-sm font-bold text-gray-800">
                        ...
                        <button type="button" id="togglePassword"
                            ...
                            <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.042-3.368m3.1-2.675A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.97 9.97 0 01-4.132 5.411M15 12a3 3 0 00-3-3m0 0a2.99 2.99 0 00-2.12.879M3 3l18 18" />
                            </svg>
                        </button>
                    </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="toggleConfirmPassword"
                            class="absolute inset-y-0 right-0 flex items-center justify-center w-12 text-gray-500 hover:text-[#1e4d2b] transition">
                            <svg id="confirmEyeIcon" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.042-3.368m3.1-2.675A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.97 9.97 0 01-4.132 5.411M15 12a3 3 0 00-3-3m0 0a2.99 2.99 0 00-2.12.879M3 3l18 18" />
                            </svg>
                        </button>
                ...
                <div class="flex flex-col items-center justify-end gap-3 mt-4 md:mt-0">
                    <button type="submit" id="btnSubmit"
                        class="w-full bg-[#c9a76d] hover:bg-[#b5955e] transition text-white font-bold py-3.5 rounded-lg shadow-sm text-base md:text-lg flex items-center justify-center gap-2 hover:-translate-y-0.5 hover:shadow-md duration-300">
