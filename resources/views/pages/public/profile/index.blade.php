...
{{-- ================= SEJARAH SECTION (STATIC VERSION) ================= --}}
    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="mb-16">
            <div class="rounded-3xl overflow-hidden shadow-xl border-8 border-white">
                {{-- Pastikan gambar ini ada di public/images/ atau path yang sesuai --}}
                <img src="{{ asset('images/1985.png') }}" alt="Pembangunan Pondok" class="w-full h-auto object-cover">
            </div>
        </div>
        ...
        <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-12">
            ...
            {{-- Quote Box --}}
            <div class="bg-[#FAFAFA] border-l-4 border-[#c9a76d] p-8 rounded-r-3xl my-12 shadow-sm">
...
{{-- ================= FASILITAS SECTION ================= --}}
{{-- KUNCI 2: Section Fasilitas & Video menggunakan bg asli background (#FAFAFA) --}}
<section id="fasilitas" class="py-24 bg-[#FAFAFA] scroll-mt-32">
    <div class="max-w-6xl mx-auto px-6">
        {{-- Header Fasilitas melayang di atas bg abu-abu --}}
        ...
        {{-- Grid Card Fasilitas (Masing-masing card punya bg-white agar menonjol) --}}
...
{{-- KUNCI KONSISTENSI: bg-white pada section agar putihnya full width seperti Sejarah --}}
<section id="video" class="py-24 bg-white scroll-mt-32 overflow-hidden border-t border-gray-50">
    <div class="max-w-6xl mx-auto px-6">
        ...
        {{-- Container Slider (Tanpa card putih lagi karena background section sudah putih) --}}
...
<script>
    ...
    // Inisialisasi Swiper untuk Video
const swiper = new Swiper('.videoSwiper', {
    ...
    effect: 'fade', // Memberikan efek transisi yang halus (smooth fade)
    fadeEffect: {
        crossFade: true
    },
});
