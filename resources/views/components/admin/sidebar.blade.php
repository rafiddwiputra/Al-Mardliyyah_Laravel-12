<aside class="w-64 bg-[#1e4d2b] min-h-screen flex flex-col text-white">
    ...
    <div class="mb-6">
        ...
        <div class="flex items-center gap-3 font-bold px-4 py-2.5 rounded-lg text-sm transition mb-2
            {{ Request::is('admin/berita*', 'admin/galeri*', 'admin/profil*', 'admin/program*', 'admin/biaya*', 'admin/jadwal*') 
        ...
        <div class="ml-6 border-l-2 border-white/30 space-y-1">
            ...
            <a href="{{ route('admin.profil') }}" class="block px-4 py-1.5 text-sm transition {{ Request::is('admin/profil-pondok*') ? 'text-[#c9a76d] font-bold' : 'hover:text-[#c9a76d]' }}">Profil Pondok</a>
